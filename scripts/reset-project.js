 ...
 * It deletes or moves the /src and /tests directories to /src-example based on user input and creates a new /src/app directory with an index.tsx and _layout.tsx file.
...
const moveDirectories = async (userInput) => {
  try {
    ...
    // Move old directories to new src-example directory or delete them
