...
The table below is the high-level requirement table used in the main report. The complete requirements register is embedded in Appendix~\ref{app:evidence}.

\begin{longtable}{>{\raggedright\arraybackslash}p{0.10\textwidth}>{\raggedright\arraybackslash}p{0.38\textwidth}>{\raggedright\arraybackslash}p{0.12\textwidth}>{\raggedright\arraybackslash}p{0.30\textwidth}}
\caption{High-level requirements based on project needs and meeting refinements.}\label{tab:high-level-requirements}\\
\toprule
