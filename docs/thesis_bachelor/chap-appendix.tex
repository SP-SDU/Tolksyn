...
Entity-relationship diagram & \attachfile[description={Local entity-relationship diagram}]{artifacts/local-persistence-model.png} & Rendered local data relationship figure. \\
...
\bottomrule
\end{tabularx}
\caption{Automated test file inventory.}
