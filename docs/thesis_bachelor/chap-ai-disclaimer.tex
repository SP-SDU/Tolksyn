...
Because generative AI tools were used for correction, proofreading, and structure suggestions, parts of the thesis may reflect a more uniform academic style than an unassisted draft. This includes corrected grammar, clearer phrasing, repeated technical terminology, and formalized sentence structure. The disclaimer therefore documents the method of use and the control mechanisms applied by the authors.
